...
module.exports = {
    ...
    async execute(interaction, client) {
        try {
            ...
            Embed.setFooter({ text: `Esta sugerencia a sido aceptada con exito!`, iconURL: interaction.user.displayAvatarURL({ dynamic: true }) });
            ...
            i.reply({
                content: `✅ **Éxito:** ¡Acepto la sugerencia del usuario!`,
                ephemeral: true,
            }).catch((error) => {});
        } catch (e) {
            interaction.reply({
