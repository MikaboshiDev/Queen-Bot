...
module.exports = {
  ...
  data: new SlashCommandBuilder()
    .setName("emoji")
    .setDescription(
      "🤬 Crea emojis multiples en el servidor o usa la opcion jumbo para verlos en grande"
    )
    .addSubcommand((options) =>
      options
        .setName("info")
        .setDescription("🤬 Muestra la informacion del emoji")
        .addStringOption((option) =>
          option
            .setName("emoji")
            .setDescription("Coloca el emoji que quieres ver la informacion")
            .setRequired(true)
        )
    ),
